...
<jsp:useBean id="listAllPrice" scope="session" type="example.ProductList"/>
<c:set var = "num_of_results" scope = "page" value = "${listAllPrice.list.size()}"/>
...
<c:forEach var="item" begin="${this_page_start_res}" end="${this_page_end_res}" varStatus="status"  items="${listAllPrice.list}">
